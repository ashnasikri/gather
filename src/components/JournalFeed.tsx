  ...
  if (items.length === 0 && !adding) return (
    <div style={{ marginBottom: "24px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
        <span style={{ fontFamily: "var(--font-dm-sans), -apple-system, sans-serif", fontSize: "11px", fontWeight: 400, color: "var(--text-faint)", letterSpacing: "1.2px", textTransform: "uppercase" }}>to do</span>
        <button onClick={() => setAdding(true)} style={{ background: "none", border: "none", cursor: "pointer", fontFamily: "var(--font-dm-sans), -apple-system, sans-serif", fontSize: "12px", color: "var(--text-faint)", padding: 0 }}>+ add</button>
      </div>
      <p style={{ fontFamily: "var(--font-dm-sans), -apple-system, sans-serif", fontSize: "12.5px", fontWeight: 300, color: "var(--text-faint)", fontStyle: "italic", margin: 0 }}>nothing yet</p>
    </div>
  );
    ...
    <div style={{ marginBottom: "24px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }}>
        <span style={{ fontFamily: "var(--font-dm-sans), -apple-system, sans-serif", fontSize: "11px", fontWeight: 400, color: "var(--text-faint)", letterSpacing: "1.2px", textTransform: "uppercase" }}>
          to do{items.length > 0 && <span style={{ color: "var(--ember)", marginLeft: "5px" }}>{items.length}</span>}
        </span>
...
export default function JournalFeed({ encounters, onEdit, onDelete, onPersonTap }: JournalFeedProps) {
  ...
  return (
    <div style={{ padding: "0 20px 120px" }}>
      ...
      <CommitmentsBlock onPersonTap={onPersonTap} />
